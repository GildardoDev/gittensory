...
Enforcement is proportional: off-scope or low-effort work is just closed, but **reward-farming**
(manufacturing low-value/slop issues to harvest credit, or bulk PRs filed for points) earns a
warning and no linked-issue bonus — and **repeat or coordinated farming, plus any plagiarism or
ban-evasion, leads to a permanent block** across our repositories. The full ladder is in
